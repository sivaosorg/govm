...
// however it won't be good for chucked transfer/compressed response. Since Restify calculates response size
...
// Basically you have taken over the control of response parsing from `Restify`.
