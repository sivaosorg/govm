...
// restify client. Request provides an options to override client level
...
type Request struct {
	...
	// Attempt is to represent the request attempt made during a Restify
...
//
//	client.R().
//		SetQueryString("productId=232&template=fresh-sample&cat=Restify&source=google&kw=buy a lot more")
...
//	client.R().
//		SetBody(User{
//			Username: "admin@s.org.com",
//			Password: "welcome2Restify",
//		})
//
...
//	client.R().
//		SetBody(`{
//			"username": "admin@getrightcare.com",
//			"password": "admin"
//		}`)
//
...
//
//	client.R().
//		SetFile("my_file", "/Users/admin/Gas Bill - Sep.pdf")
...
//				"my_file1": "/Users/admin/Gas Bill - Sep.pdf",
//				"my_file2": "/Users/admin/Electricity Bill - Sep.pdf",
//				"my_file3": "/Users/admin/Water Bill - Sep.pdf",
//			})
...
// By default Restify won't set `Content-Length`. Also you have an option to enable for every
// request.
//
...
//
// To set the header for username "go-Restify" and password "welcome"
//
//	client.R().SetBasicAuth("go-Restify", "welcome")
//
...
//
//	client.R().
//		SetOutput("/Users/admin/Downloads/ReplyWithHeader-v5.1-beta.zip").
...
// Restify current request instance.
//
...
// Restify gives this a higher priority than the `Content-Type` response header.  This means that if both
...
//	}
//
//	// Setting a cookies into Restify's current request
...
// for current `Request`.
//
//	resp, err := client.R().Execute(Restify.GET, "http://httpbin.org/get")
